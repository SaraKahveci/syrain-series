...
export default function AddSeries() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const existing = JSON.parse(localStorage.getItem('custom-series') || '[]')
    ...
    return (
      <div className="max-w-xl mx-auto p-6 text-white text-center space-y-4">
        <h2 className="text-2xl font-bold">
          You must have an account to add a new series.
        </h2>

        <Link
          to="/register"
          className="inline-block bg-pink-500 px-6 py-3 rounded font-bold"
        >
          Create Account
        </Link>
